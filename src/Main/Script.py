...
class Script:
    ...
    def __repr__(self):
        retStr = []
        retStr.append("Script: {name: ")
        retStr.append(self.name)
        retStr.append(", executable: ")
        if self.executable:
            retStr.append(self.executable)
        else:
            retStr.append('<None>')
        retStr.append(", args: ")
        retStr.append(str(self.args))
        retStr.append(", kwargs: ")
        retStr.append(str(self.kwargs))
        retStr.append("}")
        return ''.join(retStr)
...
class WindowsScript(Script):
    ...
    def toExecutableString(self):
        ...
        '''
        strList = []
        strList.append(u"cmd")
        strList.append(u"/C")
        if self.executable:
            strList.append(self.executable)
        else:
        ...
        for k in keys:
            strList.append('-' + k + '=' + self.kwargs[k])
...
class ScriptService:
    ...
    def __repr__(self):
        strList = []
        strList.append("Service: ")
        strList.append(str(self.__class__))
        strList.append(": {daos: ")
        strList.append(str(self.daos))
        strList.append("}")
        return ''.join(strList)
